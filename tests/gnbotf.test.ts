...
import { test, expect } from './fixtures/gnotf-fixture';
...
const slugs = [
    ...
    "events-page",
    "contact",
    "2020/09/30/example-post-3",
    "2020/09/30/example-post-2",
    "2020/09/30/example-post",
    "about-2",
    "meeting-info",
    "opportunities",
    "abatement-funds",
    "resources",
    "register-for-narcan-training",
    "events",
    "link-in-bio",
    "worried-about-insurance",
    "recovery-options",
    "naloxone-narcan-a-guide-to-saving-lives",
    "harm-reduction-a-lifeline-of-compassion-and-connection",
    "prevention-safe-spaces",
    "know-the-signs-a-guide-for-caregivers",
    "sober-supported-event-calendar",
    "new-filtered-table-test",
    "calendar-tests",
...
const baseURL = 'https://gnbotf.org/';
